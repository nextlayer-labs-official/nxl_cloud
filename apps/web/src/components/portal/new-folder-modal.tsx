...
export function NewFolderModal({ onCancel, onCreate, creating, error }: NewFolderModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-foreground mb-5 text-[17px] font-semibold">New folder</h2>
        <input
          ref={inputRef}
          autoFocus
          value={name}
