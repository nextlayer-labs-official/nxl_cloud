...
export function AdminLoginForm() {
  ...
  return (
    <>
      <h1 className="mb-1 text-center text-2xl font-bold tracking-[-0.02em]">Admin sign in</h1>
      <p className="text-ink-450 mb-6 text-center text-sm">
        Internal access for Nextlayer Labs staff only.
      </p>
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="a-pass" className="text-ink-700 text-[13px] font-semibold">
            Password
          </label>
          <input
            id="a-pass"
